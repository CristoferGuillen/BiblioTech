...
<div class="fade-in max-w-3xl">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-2">Agregar Nuevo Libro</h1>
        <p class="text-text-secondary">Completa la información del libro</p>
    </div>

    <!-- Form -->
    <form action="{{ route('books.store') }}" method="POST" class="bg-white rounded-xl shadow-sm p-8">
        @csrf
